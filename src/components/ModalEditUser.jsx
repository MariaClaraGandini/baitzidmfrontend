              ...
              <form>
                <div className='m-1'>
                  <div className="flex items-center gap-2">
                    ...
                    <Label htmlFor="accept" className={`flex ${isDarkMode ? 'text-white' : 'text-black dark:text-gray-900'}`}>Habilitado</Label>
                  </div>
                </div>
                <div className='grid md:grid-cols-2 sm:grid-cols-1 py-2'>
                  <div className='mx-1'>
                    <Label htmlFor="Nome" value="Nome" className={`${isDarkMode ? 'text-gray-100' : 'text-black dark:text-black'}`} />
                    <TextInput
                      id="givename"
                      placeholder="Fulano"
                      value={givename}
                      ...
                      required
                      className={`${errors.givename ? 'input-error' : ''} ${isDarkMode ? 'bginput' : 'lightbginput'}`}
                    />
                    {errors.givename && <p className="text-red-600 text-xs font-medium">{errors.givename}</p>}
                  </div>
                  <div className='mx-1'>
                    <Label htmlFor="Sobrenome" value="Sobrenome" className={`${isDarkMode ? 'text-gray-100' : 'text-black dark:text-black'}`} />
                    <TextInput
                      id="sn"
                      placeholder="Silva"
                      value={sn}
                      ...
                      required
                      className={`${errors.sn ? 'input-error' : ''} ${isDarkMode ? 'bginput' : 'lightbginput'}`}
                    />
                ...
                <div className={`grid md:grid-cols-2 sm:grid-cols-1 py-2 ${isDarkMode ? 'text-gray-100' : 'text-black'}`}>
                  <div className='mx-1'>
                    <Label htmlFor="Senha" value="Senha" className={`${isDarkMode ? 'text-gray-100' : 'text-black dark:text-black'}`} />
                    <TextInput
                      id="password"
                      type="password"
                      placeholder="**********"
                      ...
                      required
                      className={` ${errors.password ? 'input-error' : ''} ${isDarkMode ? 'bginput' : 'lightbginput'}`}
                    />
                    {errors.password && <p className="text-red-600 text-xs font-medium">{errors.password}</p>}
                  </div>
                  <div className='mx-1'>
                    <Label htmlFor="Confirme a Senha" value="Confirme a senha" className={`${isDarkMode ? 'text-gray-100' : 'text-black dark:text-black'}`} />
                    <TextInput
                      id="confirmpassword"
                      type="password"
                      placeholder="**********"
